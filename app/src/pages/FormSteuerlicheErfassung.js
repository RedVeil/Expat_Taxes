    ...
    <div style={{ paddingLeft: "1em", display: "block", justifyContent: "center", alignContent: "center" }}>
          <Grid container>
            <MuiThemeProvider theme={theme}>
              <Grid item xs={12}>
                <h2 className={styles.subTitle} className={styles.subTitle}>Personal Informations</h2>
              </Grid>
              <Grid item xs={12}>
                <InputField
                  id="u_firstname"
              ...
              <Grid item xs={12}>
                ...
                <InputField
                  id="vorwahl_tel"
                  tooltipText="The second part of your number: +49 [176] 752428790"
                  placeholder="Prefix"
                  onChangeFunction={onChangeSaveValue}
                  size="small"
                />
                <InputField
                  id="rufnummer_tel"
                  tooltipText="The third part of your number: +49 176 [75242879]"
              ...
              <Grid item xs={12} id="Your Partner-row-1" style={{ display: "none" }}>
                <InputField
                  id="marriage_date"
                  tooltipText="Enter the date in the following format: DD/MM/YYYY."
              ...
              <Grid item xs={12} id="Your Partner-row-2" style={{ display: "none" }}>
                <InputField
                  id="p_firstname"
              ...
              <Grid item xs={12} id="Your Partner-row-3" style={{ display: "none" }}>
                <InputField
                  id="p_current_job"
              ...
              <Grid item xs={12} id="Your Partner-row-4" style={{ display: "none" }}>
                <RadioField
                  id="p_reli"
              ...
              <Grid item xs={12} id="Your Partner-row-5" style={{ display: "none" }}>
                <RadioField
                  id="live_together"
              ...
              <Grid item xs={12} id="Your Partner-row-6" style={{ display: "none" }}>
                <InputField
                  id="p_strasse"
                  tooltipText=""
                  placeholder="Street"
                ...
                <InputField
                  id="p_hausnummer"
                  tooltipText="Enter their street number."
                  placeholder="Nr"
                  onChangeFunction={onChangeSaveValue}
                  size="small"
                />
                ...
                <InputField
                  id="p_city"
                  tooltipText="In which city do they live?"
                  placeholder="City"
                  onChangeFunction={onChangeSaveValue}
                  size="medium"
                />
              ...
              <Grid item xs={12} id="Your Partner-row-8" style={{ display: "none" }}>
                <InputField
                  id="widow_date"
                  tooltipText=""
              ...
              <Grid item xs={12}>
                <InputField
                  id="art_taetigkeit"
                  tooltipText='Describe your Job, Job title and the industry you are working in. Enter as much as you want.e.g. If you have a website and make money through ads and affiliate-marketing you could write: "Managment of a website with income through advertisment and affiliate-marketing"Tip: It helps to be broad in the description as you can claim more expenses.'
                ...
                <InputField
                  id="work_date"
                  tooltipText="You can backdate this by up to 3 months to include preparation costs.Enter the date in the following format: DD/MM/YYYY"
              ...
              <Grid item xs={12}>
                <RadioField
                  ...
                  tooltipText="A SEPA-Mandate allows the tax office to automatically collect your taxes. Otherwise you have to transfer your taxes manually every month.A SEPA-Mandate is easier and a good option if your account is always covered. It always comes on a fixed date but if you cant pay it you have to pay extra penalties. Dont sign this if you want more flexibility about the timing of your payments or if your account is not covered through out the whole month.<b>You will have to sign a seperate attached mandate.</b>"
                  defaultValues={["yes", "no"]}
                  placeholder={["Yes", "No"]}
                  onChangeFunction={handleRadioForms}
                />
              ...
              <Grid item xs={12} id="Tax Consultant-row-1" style={{ display: "none" }}>
                <InputField
                  id="steuerberater"
                  tooltipText="Enter the name of your tax consultancy. Skip this if they operate udner their name."
                ...
                <InputField
                  id="b_lastname"
                  tooltipText="Enter the last name of your personal tax consultant."
                  placeholder="Last Name"
                  onChangeFunction={onChangeSaveValue}
                  size="medium"
                />
              </Grid>
              <Grid item xs={12} id="Tax Consultant-row-2" style={{ display: "none" }}>
                <InputField
                  id="b_strasse"
                  tooltipText=""
                  placeholder="Street"
                ...
                <InputField
                  id="b_hausnummer"
                  tooltipText="Where is your tax consultant located?"
                  placeholder="Nr"
                  onChangeFunction={onChangeSaveValue}
                  size="small"
                />
              ...
              <Grid item xs={12} id="Tax Consultant-row-3" style={{ display: "none" }}>
                <InputField
                ...
                <InputField
                  id="b_e_mail"
                  tooltipText="What is their email adress?"
                  placeholder="Email"
                  onChangeFunction={onChangeSaveValue}
                  size="medium"
                />
              ...
              <Grid item xs={12}>
                <RadioField
                  ...
                  tooltipText='Typically you get all your documents. If someone else shall recieve them, authorize them here.This can be changed whenever you want.<b>You will have to sign a seperate attached mandate.</b>'
                  defaultValues={["me", "not me"]}
                  placeholder={["Yes", "No"]}
                  onChangeFunction={handleRadioForms}
                />
              </Grid>
              <Grid item xs={12} id="Authorized Document Recipient-row-1" style={{ display: "none" }}>
                <InputField
                  id="doc_firma"
                ...
                <InputField
                  id="doc_lastname"
                  tooltipText="Enter the last name of your authorized document recipient."
                  placeholder="Last Name"
                  onChangeFunction={onChangeSaveValue}
                  size="medium"
                />
              </Grid>
              <Grid item xs={12} id="Authorized Document Recipient-row-2" style={{ display: "none" }}>
                <InputField
                  id="doc_strasse"
                  tooltipText=""
                  placeholder="Street"
                ...
                <InputField
                  id="doc_hausnummer"
                  tooltipText="Where is your authorized document recipient located?"
                  placeholder="Nr"
                  onChangeFunction={onChangeSaveValue}
                  size="small"
                />
              ...
              <Grid item xs={12} id="Authorized Document Recipient-row-3" style={{ display: "none" }}>
                <InputField
              ...
              <Grid item xs={12}>
                <RadioField
                  ...
                  tooltipText="This is is important for the tax office to know. If you have moved, you were registered at another tax office before, so they can request your old data."
                  defaultValues={["yes", "no"]}
                  placeholder={["Yes", "No"]}
                  onChangeFunction={handleRadioForms}
                />
              </Grid>
              <Grid item xs={12} id="Previous Residence-row-1" style={{ display: "none" }}>
                <InputField
                  id="migration_date"
                  tooltipText="When did you move to your new home?Enter the date in the following format: DD/MM/YYYY"
                  placeholder="Moving Date"
                  onChangeFunction={onChangeSaveValue}
                  size="medium"
                />
              </Grid>
              <Grid item xs={12} id="Previous Residence-row-2" style={{ display: "none" }}>
                <InputField
                  id="pre_strasse"
                  tooltipText=""
                  placeholder="Street"
              ...
              <Grid item xs={12} id="Previous Residence-row-4" style={{ display: "none" }}>
                <InputField
                  id="pre_finanzamt"
                  tooltipText=""
              ...
              <Grid item xs={12}>
                <RadioField
                  ...
                  tooltipText="Where do you want to register your business? All documents and letters will be send there.If your workplace is a studio or workshop, it might make sense to register your business at your home adress.<b>Your doorbell and mailbox must be tagged with the name of your business.</b>(This is obviously not necessary if you simply use your own name)"
                  defaultValues={["home", "not home"]}
                  placeholder={["Home", "Somewhere Else"]}
                  onChangeFunction={handleRadioForms}
                />
              </Grid>
              <Grid item xs={12} id="Business Address-row-1" style={{ display: "none" }}>
                <InputField
                  id="firm_bezeichnung"
              ...
              <Grid item xs={12} id="Business Address-row-2" style={{ display: "none" }}>
                <InputField
                  id="firm_strasse"
                  tooltipText=""
                  placeholder="Street"
                ...
                <InputField
                  id="firm_hausnummer"
                  tooltipText="Enter the adress on which your business will be registered."
                  placeholder="Nr"
                  onChangeFunction={onChangeSaveValue}
                  size="small"
                />
              ...
              <Grid item xs={12} id="Business Address-row-3" style={{ display: "none" }}>
                <InputField
              ...
              <Grid item xs={12} id="Business Address-row-4" style={{ display: "none" }}>
                <InputField
                  id="firm_e_mail"
              ...
              <Grid item xs={12}>
                ...
                <InputField
                  id="u_betrag1"
                  tooltipText='Enter your expected income through self-employment for the first year of your business. All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end.  <b>Important</b>You can enter your self-employment income here only if your job is in this <a href="" target="_blank" rel="noopener noreferrer">list.</a> Otherwise you enter it in "Business Revenue".'
                ...
                <InputField
                  id="u_betrag2"
                  tooltipText="Enter your expected income through employment for the first year of your business. All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
                  placeholder="Salary"
                  onChangeFunction={onChangeSaveValue}
                  size="medium"
                />
                <InputField
                  id="u_betrag3"
                  tooltipText="Enter your expected income through investments for the first year of your business. All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
                ...
                <InputField
                  id="u_betrag9"
                  tooltipText="Enter the estimated revenue of your business for the first year. All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
              ...
              <Grid item xs={12}>
                <InputField
                  id="u_betrag4"
                  tooltipText="Enter your expected income through other sources for the first year of your business.This could be child benefits, BaföG, scholarships or grants etc.All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
                ...
                <InputField
                  ...
                  tooltipText='Enter the sum of your estimated special expenses. Those could be insurance, professional liability etc.For a more comprehensive list click here: <a href="" target="_blank" rel="noopener noreferrer">german </a>, <a href="" target="_blank" rel="noopener noreferrer">english</a>'
              ...
              <Grid item xs={12}>
                ...
                <InputField
                  id="u_betrag5"
                  tooltipText='Enter your expected income through self-employment for the second year of your business.All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end. <b>Important</b>You can enter your self-employment income here only if your job is in this <a href="" target="_blank" rel="noopener noreferrer">list.</a> Otherwise you enter it in Business Revenue.'
                  placeholder="Selfemployment Income"
                  onChangeFunction={onChangeSaveValue}
                  size="medium"
                />
                <InputField
                  id="u_betrag6"
                  tooltipText="Enter your expected income through employment for the second year of your business.All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
                  placeholder="Salary"
                  onChangeFunction={onChangeSaveValue}
                  size="medium"
                />
                <InputField
                  id="u_betrag7"
                  tooltipText="Enter your expected income through investments for the second year of your business.All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
                  placeholder="Capital Gains"
                ...
                <InputField
                  id="u_betrag10"
                  tooltipText="Enter the estimated revenue of your business for the second year.All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
                  placeholder="Business Revenue"
                  onChangeFunction={onChangeSaveValue}
                  size="medium"
                />
              ...
              <Grid item xs={12}>
                <InputField
                  id="u_betrag8"
                  tooltipText="Enter your expected income through other sources for the second year of your business. be child benefits, BaföG, scholarships or grants etc.All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
                  placeholder="Other Income"
                  onChangeFunction={onChangeSaveValue}
                  size="medium"
                />
                <InputField
                  ...
                  tooltipText='Enter the sum of your estimated special expenses. Those could be insurance, professional liability etc.For a more comprehensive list click here: <a href="localhost:3000/specialExpensesListGerman" target="_blank" rel="noopener noreferrer">german</a>,<a href="" target="_blank" rel="noopener noreferrer">english</a>'
                  placeholder="Special Expenses"
                  onChangeFunction={onChangeSaveValue}
                  size="medium"
                />
              ...
              <div id="Partner Expected Income-section" style={{ display: "none" }}>
                <Grid item xs={12}>
                ...
                <Grid item xs={12}>
                  ...
                  <InputField
                    id="p_betrag1"
                    tooltipText='Enter their expected income through self-employment for the first year of their business. All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end.  <b>Important</b>You can enter their self-employment income here only if their job is in this <a href="" target="_blank" rel="noopener noreferrer">list.</a> Otherwise you enter it in Business Revenue.'
                    placeholder="Selfemployment Income"
                    onChangeFunction={onChangeSaveValue}
                    size="medium"
                  />
                  <InputField
                    id="p_betrag2"
                    tooltipText="Enter their expected income through employment for the first year of their business. All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
                    placeholder="Salary"
                    onChangeFunction={onChangeSaveValue}
                    size="medium"
                  />
                  <InputField
                    id="p_betrag3"
                    tooltipText="Enter their expected income through investments for the first year of their business. All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
                    placeholder="Capital Gains"
                    onChangeFunction={onChangeSaveValue}
                    size="medium"
                  />
                  <InputField
                    id="p_betrag9"
                    tooltipText="Enter the estimated revenue of their business for the first year. All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
                    placeholder="Business Revenue"
                    onChangeFunction={onChangeSaveValue}
                    size="medium"
                  />
                ...
                <Grid item xs={12}>
                  <InputField
                    id="p_betrag4"
                    tooltipText="Enter their expected income through other sources for the first year of their business.This could be child benefits, BaföG, scholarships or grants etc.All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
                    placeholder="Other Income"
                  ...
                  <InputField
                    ...
                    tooltipText='Enter the sum of their estimated special expenses. Those could be insurance, professional liability etc.For a more comprehensive list click here: <a href="" target="_blank" rel="noopener noreferrer">german </a>, <a href="" target="_blank" rel="noopener noreferrer">english</a>'
                    placeholder="Special Expenses"
                ...
                <Grid item xs={12}>
                  ...
                  <InputField
                    id="p_betrag5"
                    tooltipText='Enter their expected income through self-employment for the second year of their business.All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end. <b>Important</b>You can enter their self-employment income here only if their job is in this <a href="" target="_blank" rel="noopener noreferrer">list.</a> Otherwise you enter it in Business Revenue.'
                    placeholder="Selfemployment Income"
                  ...
                  <InputField
                    id="p_betrag6"
                    tooltipText="Enter their expected income through employment for the second year of their business.All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
                    placeholder="Salary"
                  ...
                  <InputField
                    id="p_betrag7"
                    tooltipText="Enter their expected income through investments for the second year of their business.All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
                    placeholder="Capital Gains"
                  ...
                  <InputField
                    id="p_betrag10"
                    tooltipText="Enter the estimated revenue of their business for the second year.All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
                    placeholder="Business Revenue"
                    onChangeFunction={onChangeSaveValue}
                    size="medium"
                  />
                ...
                <Grid item xs={12}>
                  <InputField
                    id="p_betrag8"
                    tooltipText="Enter their expected income through other sources for the second year of their business. be child benefits, BaföG, scholarships or grants etc.All of these numbers should estimates.There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end."
                    placeholder="Other Income"
                  ...
                  <InputField
                    ...
                    tooltipText='Enter the sum of their estimated special expenses. Those could be insurance, professional liability etc.For a more comprehensive list click here: <a href="localhost:3000/specialExpensesListGerman" target="_blank" rel="noopener noreferrer">german</a>,<a href="" target="_blank" rel="noopener noreferrer">english</a>'
                    placeholder="Special Expenses"
              ...
              <Grid item xs={12} id="Previous Business-row-1" style={{ display: "none" }}>
                <InputField
                  id="old_business_name"
                  tooltipText="What was the name of your old business? <br/>Leave this out if you were simply self-employed."
                ...
                <InputField
                  ...
                  tooltipText="When did you start it?<br/>Enter the date in the following format: DD/MM/YYYY"
                ...
                <InputField
                  ...
                  tooltipText="When did it end?<br/>Enter the date in the following format: DD/MM/YYYY"
                  placeholder="End Date"
                  onChangeFunction={onChangeSaveValue}
                  size="medium"
                />
              </Grid>
              <Grid item xs={12} id="Previous Business-row-2" style={{ display: "none" }}>
                <InputField
              ...
              <Grid item xs={12} id="Handelsregister-row-1" style={{ display: "none" }}>
                <InputField
              ...
              <Grid item xs={12} id="Handelsregister-row-2" style={{ display: "none" }}>
                <RadioField
              ...
              <Grid item xs={12} id="Handelsregister-row-3" style={{ display: "none" }}>
                <InputField
                  id="registration_done_date"
                  tooltipText="When did you submit your application?<br/>Enter the date in the following format: DD/MM/YYYY"
                  placeholder="Date"
                  onChangeFunction={onChangeSaveValue}
                  size="medium"
                />
              ...
              <Grid item xs={12}>
                <RadioField
                  ...
                  tooltipText="If your total revenue (Umsatz) is lower than 19.000€ you may decide to use the Kleinunternehmer-Regel (Small Business Rule).This means you dont have to pay any sales tax (Umsatzsteuer). <br/><b>In this case you can obviously not add sales tax to your receivables.</b><br/><br/>If you click 'No' you simply pay sales tax and add it to your receivables."
                  defaultValues={["yes", "no"]}
                  placeholder={["Yes", "No"]}
                  onChangeFunction={handleRadioForms}
                />
