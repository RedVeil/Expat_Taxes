...
export const steuerlicheErfassungFormData = [
  {
    title: "Personal Informations", display: "block", inputFields: [
      ...
      [{ name: "u_strasse", tooltip: <p className="tooltipText">Enter the street you live in.</p>, top: 9, defaultValue: null, placeholder: "Street", type: null, size: "medium", margin: "medium" },
      { name: "u_hausnummer", tooltip: <p className="tooltipText">Enter your street number.</p>, top: 9, defaultValue: null, placeholder: "Nr", type: null, size: "small", margin: "small" },
...

  {
    title: "Tax Consultant", display: "block", inputFields: [
      ...
      ["invisible", { name: "steuerberater", tooltip: <p className="tooltipText">Enter the name of your tax consultancy. Skip this if they operate udner their name.</p>, top: 9, defaultValue: null, placeholder: "Consultant Office", type: null, size: "medium", margin: "medium" },
      { name: "b_firstname", tooltip: <p className="tooltipText">Enter the first name of your personal tax consultant.</p>, top: 9, defaultValue: null, placeholder: "First Name", type: null, size: "medium", margin: "medium" },
      { name: "b_lastname", tooltip: <p className="tooltipText">Enter the last name of your personal tax consultant.</p>, top: 9, defaultValue: null, placeholder: "Last Name", type: null, size: "medium", margin: "medium" },],
  ...
  },
  {
    title: "Authorized Document Recipient", display: "block", inputFields: [
      ...
      ["invisible", { name: "doc_firma", tooltip: <p className="tooltipText">Enter this only if applicable.</p>, top: 9, defaultValue: null, placeholder: "Company Name", type: null, size: "medium", margin: "medium" },
        { name: "doc_firstname", tooltip: <p className="tooltipText">Enter the first name of your authorized document recipient.</p>, top: 9, defaultValue: null, placeholder: "First Name", type: null, size: "medium", margin: "medium" },
        { name: "doc_lastname", tooltip: <p className="tooltipText">Enter the last name of your authorized document recipient.</p>, top: 9, defaultValue: null, placeholder: "Last Name", type: null, size: "medium", margin: "medium" },],
...

  {
    title: "Previous Residence", display: "block", inputFields: [
      ...
      top: 9, defaultValue: null, placeholder: "Moving Date", type: null, size: "medium", margin: "medium" },],
...

  {
    title: "Previous Business", display: "block", inputFields: [
      ...
      ["invisible",
        ...
        { name: "old_business_city", tooltip: <p className="tooltipText">Where did you worked/ Where was your business?</p>, top: 9, defaultValue: "", placeholder: "City", type: null, size: "medium", margin: "medium" },
        { name: "old_business_start_date", tooltip: <p className="tooltipText">When did you start it?<br/>Enter the date in the following format: DD/MM/YYYY</p>, top: 9, defaultValue: "", placeholder: "Start Date", type: null, size: "medium", margin: "medium" },
        { name: "old_business_end_date", tooltip: <p className="tooltipText">When did it end?<br/>Enter the date in the following format: DD/MM/YYYY</p>, top: 9, defaultValue: "", placeholder: "End Date", type: null, size: "medium", margin: "medium" },],
      ["invisible",
...

  {
    title: "Handelsregister", display: "block", inputFields: [
      ...
      ["invisible",
        { name: "handelsregister_date", tooltip: <p className="tooltipText">Since when is your business registered</p>, top: 9, defaultValue: "",  placeholder: "Date",type: null, size: "medium", margin: "medium" },
        { name: "handelsregister_city1", tooltip: <p className="tooltipText">In which city is your business registered?</p>, top: 9, defaultValue: "",  placeholder: "City",type: null, size: "medium", margin: "medium" },
        { name: "registry_number1", tooltip: <p className="tooltipText">What is your registry number?</p>, top: 9, defaultValue: "",  placeholder: "Registry Number",type: null, size: "medium", margin: "medium" },],
      ["invisible",
      { name: "handelsregister_application_done", text: "Did you submit your application?", 
      tooltip: <p className="tooltipText">Did you submit your application to a local court?</p>, top: 9, defaultValue: ["yes", "no"], placeholder: ["Yes", "Not Yet"], type: "radio", size: "medium", margin: "medium" },
