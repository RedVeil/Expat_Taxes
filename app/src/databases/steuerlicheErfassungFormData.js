...
export const steuerlicheErfassungFormData = [
  {
    title: "Personal Informations", display: "block", inputFields: [
      ...
      [{ name: "migration_date", tooltip: <p className="tooltipText">Only if you moved to your current city during the last 12 Months. <br />Enter the date in the following format: DD/MM/YYYY</p>, top: 21, defaultValue: null, placeholder: "Migration Date", type: null, size: "medium", margin: "medium" },],
      [{
...

  {
    title: "Your Partner", display: "block", inputFields: [
      ...
      ["invisible", {
        name: "p_reli", text: "Do they have to pay church tax?", tooltip: <p className="tooltipText">Church tax is added to their regular tax and send directly to their church.</p>, top: 21.5,
        defaultValue: ["EV", "RK", "VD"], placeholder: ["Evangelic", "Roman Catholic", "No Christian Church Tax"], type: "radio", size: "medium", margin: "medium"
      },],
  ...
  <br />For a more comprehensive list click here: <a href="" target="_blank" rel="noopener noreferrer">german</a>
      ...
      { name: "sum1", tooltip: <p className="tooltipText">...</p>, top: 11.5, defaultValue: null, placeholder: "Total Revenue", type: null, size: "medium", margin: "medium" },],
  ...
  <br />All of these numbers should estimates.<br /><br />There is no direct consquence if these numbers dont hold up to reality. As a rule of thumb keep it at the lower reasonable end. <br /><br />
          <b>Important</b><br />You can enter your self-employment income here only if your job is in this <a href="" target="_blank" rel="noopener noreferrer">list.</a> Otherwise you enter it in Business Revenue.</p>, top: 16, defaultValue: null, placeholder: "Selfemployment Income", type: null, size: "medium", margin: "medium"
      },
      {
  ...
  <br />For a more comprehensive list click here: <a href="localhost:3000/specialExpensesListGerman" target="_blank" rel="noopener noreferrer">german</a>
          <a href="" target="_blank" rel="noopener noreferrer">english</a></p>, top: 18, defaultValue: null, placeholder: "Special Expenses", type: null, size: "medium", margin: "medium"
      },
      { name: "u_steuerabzug2", tooltip: <p className="tooltipText">...</p>, top: 18, defaultValue: null, placeholder: "Tax Deductions", type: null, size: "medium", margin: "medium" },
      { name: "sum2", tooltip: <p className="tooltipText">Simply add your Business Revenue to your Selfemployment Income.</p>, top: 20, defaultValue: null, placeholder: "Total Revenue", type: null, size: "medium", margin: "medium" },],
    ]
  },
  ...
  <br />For a more comprehensive list click here: <a href="" target="_blank" rel="noopener noreferrer">german</a>
      ...
      { name: "p_steuerabzug1", tooltip: <p className="tooltipText">Enter the sum of their estimated special expenses.</p>, top: 11.5, defaultValue: null, placeholder: "Tax Deductions", type: null, size: "medium", margin: "medium" },],
      [{ type: "text", text: "Second Year" }],
      [{
  ...
  <br />For a more comprehensive list click here: <a href="localhost:3000/specialExpensesListGerman" target="_blank" rel="noopener noreferrer">german</a>
      ...
      { name: "p_steuerabzug2", tooltip: <p className="tooltipText">...</p>, top: 20, defaultValue: null, placeholder: "Tax Deductions", type: null, size: "medium", margin: "medium" },],
    ]
  },
  ...
  {
    title: "Unique Tax Rules", display: "block", inputFields: [
