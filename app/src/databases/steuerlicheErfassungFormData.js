...
{title: "Your Partner", inputFields:[
  ...
  ["invisible",{name: "marriage_date", xLocationId: 10, yLocationId: 9, tooltip: <p>Enter the date in the following format: DD/MM/YYYY.</p>, defaultValue: null, placeholder: "Marriage Date", type: null, size:8, margin:1},],
  ["invisible",{name: "p_firstname", xLocationId: 2, yLocationId: 10, tooltip: <p>You know the deal.</p>, defaultValue: null, placeholder: "First Name", type: null, size:8, margin:1},
  ...
  ["invisible",{name: "p_current_job", xLocationId: 1, yLocationId: 12, tooltip: <p>If they have more than one Job, choose the one where they earn the most. If this is also difficult choose the one where they work the most hours.</p>, defaultValue: null, placeholder: "Job Title/ Job Description", type: null, size:12, margin:1},
  ...
  ["invisible",{name: "live_together", xLocationId: null, yLocationId: null, tooltip: <p>...</p>, defaultValue: ["yes","no"], placeholder: ["yes","no"], type: "radio", size:8, margin:1},],
  ["invisible",{name: "p_strasse", xLocationId: 1, yLocationId: 13, tooltip: <p>...</p>, defaultValue: null, placeholder: "Street", type: null, size:14, margin:0.3},
  ...
  ["invisible",{name: "p_reli", xLocationId: 9, yLocationId: 16, tooltip: <p>...</p>, defaultValue: ["EV","RK","VD"], placeholder: ["Evangelic","Roman Catholic","No Religion"], type: "radio", size:8, margin:1},],
  ...
  ["invisible",{name: "widow_date", xLocationId: 11, yLocationId: 9, tooltip: <p>Enter the date in the following format: DD/MM/YYYY.</p>, defaultValue: null, placeholder: "Widow Date", type: null, size:8, margin:1},
...
{title: "Tax Consultant", inputFields:[
  ...
  ["invisible",{name: "steuerberater", xLocationId: 15, yLocationId: 33, tooltip: <p>...</p>, defaultValue: null, placeholder: "Consultant Office", type: null, size:12, margin:1},],
  ["invisible",{name: "b_lastname", xLocationId: 15, yLocationId: 34, tooltip: <p>...</p>, defaultValue: null, placeholder: "Last Name", type: null, size:8, margin:1},
  ...
  ["invisible",{name: "b_strasse", xLocationId: 15, yLocationId: 35, tooltip: <p>...</p>, defaultValue: null, placeholder: "Street", type: null, size:12, margin:0.3},
  ...
  ["invisible",{name: "b_tel_int_vorwahl", xLocationId: 15, yLocationId: 38, tooltip: <p>...</p>, defaultValue: null, placeholder: "Country Code", type: null, size:3, margin:0.3},
...
{title: "Document Recipient", inputFields:[
  ...
  ["invisible",{name: "doc_firma", xLocationId: 1, yLocationId: 40, tooltip: <p>Enter this only if applicable.</p>, defaultValue: null, placeholder: "Company Name", type: null, size:12, margin:1},
  ...
  ["invisible",{name: "doc_strasse", xLocationId: 1, yLocationId: 42, tooltip: <p>...</p>, defaultValue: null, placeholder: "Street", type: null, size:12, margin:0.3},
  ...
  ["invisible",{name: "doc_tel_int_vorwahl", xLocationId: 1, yLocationId: 45, tooltip: <p>...</p>, defaultValue: null, placeholder: "Country Code", type: null, size:3, margin:0.3},
  ...
  ["invisible",{name: "doc_e_mail", xLocationId: 1, yLocationId: 46, tooltip: <p>...</p>, defaultValue: null, placeholder: "Email", type: null, size:8, margin:1},],
]},
...
{title: "Workplace",inputFields:[
  ...
  ["invisible",{name: "firm_bezeichnung", xLocationId: 1, yLocationId: 53, tooltip: <p>?</p>, defaultValue: null, placeholder: "Company Name", type: null, size:12, margin:1},],
  ["invisible",{name: "firm_strasse", xLocationId: 1, yLocationId: 54, tooltip: <p>?</p>, defaultValue: null, placeholder: "Street", type: null, size:12, margin:0.3},
  ...
  ["invisible",{name: "firm_tel_int_vorwahl", xLocationId: 1, yLocationId: 60, tooltip: <p>?</p>, defaultValue: null, placeholder: "Country Code", type: null, size:3, margin:0.3},
  ...
  ["invisible",{name: "firm_e_mail", xLocationId: 1, yLocationId: 61, tooltip: <p>?</p>, defaultValue: null, placeholder: "Email", type: null, size:8, margin:1},
